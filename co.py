...
def bossing_checklist_popup():
    ...
    bc_hh_check = tk.Checkbutton(bc_win, text='Hard Hilla')
    bc_cyg_check = tk.Checkbutton(bc_win, text='Cygnus')
    bc_czak_check = tk.Checkbutton(bc_win, text='Chaos Zakum')
    bc_pno_check = tk.Checkbutton(bc_win, text='Princess No')
    bc_cqueen_check = tk.Checkbutton(bc_win, text='Chaos Queen')
    bc_cpierre_check = tk.Checkbutton(bc_win, text='Chaos Pierre')
    bc_cvonbon_check = tk.Checkbutton(bc_win, text='Chaos Von Bon')
    bc_cvell_check = tk.Checkbutton(bc_win, text='Chaos Vellum')
    bc_akechi_check = tk.Checkbutton(bc_win, text='Akechi Mitsuhide')
    bc_hmag_check = tk.Checkbutton(bc_win, text='Hard Magnus')

    # second column of bosses
    bc_cpap_check = tk.Checkbutton(bc_win, text='Chaos Papulatus')
    bc_lotus_check = tk.Checkbutton(bc_win, text='Lotus')
    bc_damien_check = tk.Checkbutton(bc_win, text='Damien')
    bc_gslime_check = tk.Checkbutton(bc_win, text='Guardian Slime')
    bc_lucid_check = tk.Checkbutton(bc_win, text='Lucid')
    bc_will_check = tk.Checkbutton(bc_win, text='Will')
    bc_gloom_check = tk.Checkbutton(bc_win, text='Gloom')
    bc_darknell_check = tk.Checkbutton(bc_win, text='Darknell')
