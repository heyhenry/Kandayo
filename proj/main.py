...
def bossing_checklist_popup():
    ...
    hh_clear_status = tk.Checkbutton(bc_win)
    ...
    cyg_clear_status = tk.Checkbutton(bc_win)
    ...
    czak_clear_status = tk.Checkbutton(bc_win)
    ...
    pno_clear_status = tk.Checkbutton(bc_win)
    ...
    cqueen_clear_status = tk.Checkbutton(bc_win)
    ...
    cpierre_clear_status = tk.Checkbutton(bc_win)
    ...
    cvonbon_clear_status = tk.Checkbutton(bc_win)
    ...
    cvell_clear_status = tk.Checkbutton(bc_win)
    ...
    akechi_clear_status = tk.Checkbutton(bc_win)
    ...
    hmag_clear_status = tk.Checkbutton(bc_win)
    ...
    cpap_clear_status = tk.Checkbutton(bc_win)
    ...
    lotus_clear_status = tk.Checkbutton(bc_win)
    ...
    damien_clear_status = tk.Checkbutton(bc_win)
    ...
    gslime_clear_status = tk.Checkbutton(bc_win)
    ...
    lucid_clear_status = tk.Checkbutton(bc_win)
    ...
    will_clear_status = tk.Checkbutton(bc_win)
    ...
    gloom_clear_status = tk.Checkbutton(bc_win)
    ...
    darknell_clear_status = tk.Checkbutton(bc_win)
    ...
    vhilla_clear_status = tk.Checkbutton(bc_win)
    ...
    seren_clear_status = tk.Checkbutton(bc_win)
    ...
    kaling_clear_status = tk.Checkbutton(bc_win)
    ...
    bm_clear_status = tk.Checkbutton(bc_win)

    bossing_checklist_title.grid(row=0, columnspan=6)
    character_details_lbl.grid(row=1, columnspan=6)

    cpb_name.grid(row=2, column=0)
    cpb_img.grid(row=3, column=0)
    cpb_difficulty.grid(row=4, column=0)
    cpb_party_size.grid(row=5, column=0)
    cpb_clear_status.grid(row=6, column=0)

    hh_name.grid(row=2, column=1)
    hh_img.grid(row=3, column=1)
    hh_difficulty.grid(row=4, column=1)
    hh_party_size.grid(row=5, column=1)
    hh_clear_status.grid(row=6, column=1)

    cyg_name.grid(row=2, column=2)
    cyg_img.grid(row=3, column=2)
    cyg_difficulty.grid(row=4, column=2)
    cyg_party_size.grid(row=5, column=2)
    cyg_clear_status.grid(row=6, column=2)

    czak_name.grid(row=2, column=3)
    czak_img.grid(row=3, column=3)
    czak_difficulty.grid(row=4, column=3)
    czak_party_size.grid(row=5, column=3)
    czak_clear_status.grid(row=6, column=3)

    pno_name.grid(row=2, column=4)
    pno_img.grid(row=3, column=4)
    pno_difficulty.grid(row=4, column=4)
    pno_party_size.grid(row=5, column=4)
    pno_clear_status.grid(row=6, column=4)

    cqueen_name.grid(row=2, column=5)
    cqueen_img.grid(row=3, column=5)
    cqueen_difficulty.grid(row=4, column=5)
    cqueen_party_size.grid(row=5, column=5)
    cqueen_clear_status.grid(row=6, column=5)

    cpierre_name.grid(row=7, column=0)
    cpierre_img.grid(row=8, column=0)
    cpierre_difficulty.grid(row=9, column=0)
    cpierre_party_size.grid(row=10, column=0)
    cpierre_clear_status.grid(row=11, column=0)

    cvonbon_name.grid(row=7, column=1)
    cvonbon_img.grid(row=8, column=1)
    cvonbon_difficulty.grid(row=9, column=1)
    cvonbon_party_size.grid(row=10, column=1)
    cvonbon_clear_status.grid(row=11, column=1)

    cvell_name.grid(row=7, column=2)
    cvell_img.grid(row=8, column=2)
    cvell_difficulty.grid(row=9, column=2)
    cvell_party_size.grid(row=10, column=2)
    cvell_clear_status.grid(row=11, column=2)

    akechi_name.grid(row=7, column=3)
    akechi_img.grid(row=8, column=3)
    akechi_difficulty.grid(row=9, column=3)
    akechi_party_size.grid(row=10, column=3)
    akechi_clear_status.grid(row=11, column=3)

    hmag_name.grid(row=7, column=4)
    hmag_img.grid(row=8, column=4)
    hmag_difficulty.grid(row=9, column=4)
    hmag_party_size.grid(row=10, column=4)
    hmag_clear_status.grid(row=11, column=4)

    cpap_name.grid(row=7, column=5)
    cpap_img.grid(row=8, column=5)
    cpap_difficulty.grid(row=9, column=5)
    cpap_party_size.grid(row=10, column=5)
    cpap_clear_status.grid(row=11, column=5)

    lotus_name.grid(row=12, column=0)
    lotus_img.grid(row=13, column=0)
    lotus_difficulty.grid(row=14, column=0)
    lotus_party_size.grid(row=15, column=0)
    lotus_clear_status.grid(row=16, column=0)

    damien_name.grid(row=12, column=1)
    damien_img.grid(row=13, column=1)
    damien_difficulty.grid(row=14, column=1)
    damien_party_size.grid(row=15, column=1)
    damien_clear_status.grid(row=16, column=1)

    gslime_name.grid(row=12, column=2)
    gslime_img.grid(row=13, column=2)
    gslime_difficulty.grid(row=14, column=2)
    gslime_party_size.grid(row=15, column=2)
    gslime_clear_status.grid(row=16, column=2)

    lucid_name.grid(row=12, column=3)
    lucid_img.grid(row=13, column=3)
    lucid_difficulty.grid(row=14, column=3)
    lucid_party_size.grid(row=15, column=3)
    lucid_clear_status.grid(row=16, column=3)

    will_name.grid(row=12, column=4)
    will_img.grid(row=13, column=4)
    will_difficulty.grid(row=14, column=4)
    will_party_size.grid(row=15, column=4)
    will_clear_status.grid(row=16, column=4)

    gloom_name.grid(row=12, column=5)
    gloom_img.grid(row=13, column=5)
    gloom_difficulty.grid(row=14, column=5)
    gloom_party_size.grid(row=15, column=5)
    gloom_clear_status.grid(row=16, column=5)

    darknell_name.grid(row=17, column=0)
    darknell_img.grid(row=18, column=0)
    darknell_difficulty.grid(row=19, column=0)
    darknell_party_size.grid(row=20, column=0)
    darknell_clear_status.grid(row=21, column=0)

    vhilla_name.grid(row=17, column=1)
    vhilla_img.grid(row=18, column=1)
    vhilla_difficulty.grid(row=19, column=1)
    vhilla_party_size.grid(row=20, column=1)
    vhilla_clear_status.grid(row=21, column=1)

    seren_name.grid(row=17, column=2)
    seren_img.grid(row=18, column=2)
    seren_difficulty.grid(row=19, column=2)
    seren_party_size.grid(row=20, column=2)
    seren_clear_status.grid(row=21, column=2)

    kaling_name.grid(row=17, column=3)
    kaling_img.grid(row=18, column=3)
    kaling_difficulty.grid(row=19, column=3)
    kaling_party_size.grid(row=20, column=3)
    kaling_clear_status.grid(row=21, column=3)

    bm_name.grid(row=17, column=4)
    bm_img.grid(row=18, column=4)
    bm_difficulty.grid(row=19, column=4)
    bm_party_size.grid(row=20, column=4)
    bm_clear_status.grid(row=21, column=4)
