...
def add_character_popup():
    ...
    ac_ign_entry = tk.Entry(ac_win, textvariable=ac_ign, bg='#ffffff', highlightbackground='#161b28', highlightcolor='#6F85B6', highlightthickness=2)
    ac_job_lbl = tk.Label(ac_win, text='Job (Class):', font=('Kozuka Gothic Pro B', 12), bg='#DBEDF3')
    ac_job_entry = tk.Entry(ac_win, textvariable=ac_job, bg='#ffffff', highlightbackground='#161b28', highlightcolor='#6F85B6', highlightthickness=2)
    ac_level_lbl = tk.Label(ac_win, text='Level:', font=('Kozuka Gothic Pro B', 12), bg='#DBEDF3')
    ac_level_entry = tk.Entry(ac_win, textvariable=ac_level, bg='#ffffff', highlightbackground='#161b28', highlightcolor='#6F85B6', highlightthickness=2)
...
def bossing_checklist_popup():
    ...
    cpb_clear_status = tk.Checkbutton(bc_win, image=incomplete_status_icon, variable=cpb_status, command=lambda:update_check_status('Chaos Pink Bean', cpb_status, cpb_clear_status))
